...
// Находим ссылку-баннер
const siteLink = document.getElementById('top-banner-link'); 

if (siteLink) {
    siteLink.addEventListener('click', () => {
        // Проверяем, существует ли объект музыки, и ставим его на паузу
        if (typeof music !== 'undefined') {
            music.pause();
        }
        // Если ты хочешь также сбросить время в начало:
        // music.currentTime = 0; 
        });
    }
});